...
bool StudioEventEmitter3DGizmoPlugin::has_gizmo(Node3D* for_node_3d)
{
	if (for_node_3d)
	{
...
String StudioEventEmitter3DGizmoPlugin::get_gizmo_name() const
{
	return "StudioEventEmitter3D";
}

int32_t StudioEventEmitter3DGizmoPlugin::get_priority() const
{
	return -1;
}

void StudioEventEmitter3DGizmoPlugin::redraw(EditorNode3DGizmo *gizmo)
{
	EditorNode3DGizmo* gizmo_ref = const_cast<EditorNode3DGizmo*>(gizmo);
	gizmo_ref->clear();

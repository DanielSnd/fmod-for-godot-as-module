...
void StudioGlobalParameterTrigger::do_enter_tree()
{
	handle_game_event(FmodGameEvent::GAMEEVENT_ENTER_TREE);
}
...
void StudioGlobalParameterTrigger::do_exit_tree()
{
	handle_game_event(FmodGameEvent::GAMEEVENT_EXIT_TREE);
}

void StudioGlobalParameterTrigger::handle_game_event(FmodGameEvent game_event)
{
...
void StudioGlobalParameterTrigger::set_trigger_on(FmodGameEvent _trigger_on)
{
	this->trigger_on = _trigger_on;
}

FmodGameEvent StudioGlobalParameterTrigger::get_trigger_on() const
{
	return trigger_on;
}

void StudioGlobalParameterTrigger::set_parameter(const Ref<ParameterAsset>& _parameter)
{

...
template <typename T>
void StudioEventEmitterImpl<T>::handle_game_event(FmodGameEvent game_event)
{
...
void StudioEventEmitter2D::do_enter_tree()
{
...
void StudioEventEmitter2D::do_process(double p_delta)
{
	implementation._process(p_delta);
}

void StudioEventEmitter2D::handle_game_event(FmodGameEvent game_event)
{
...
void StudioEventEmitter2D::set_play_event(FmodGameEvent play_event)
{
	implementation.play_event = play_event;
}

FmodGameEvent StudioEventEmitter2D::get_play_event() const
{
	return implementation.play_event;
}

void StudioEventEmitter2D::set_stop_event(FmodGameEvent stop_event)
{
	implementation.stop_event = stop_event;
}

FmodGameEvent StudioEventEmitter2D::get_stop_event() const
{
...
void StudioEventEmitter3D::set_play_event(FmodGameEvent play_event)
{
	implementation.play_event = play_event;
}

FmodGameEvent StudioEventEmitter3D::get_play_event() const
{
	return implementation.play_event;
}

void StudioEventEmitter3D::set_stop_event(FmodGameEvent stop_event)
{
	implementation.stop_event = stop_event;
}

FmodGameEvent StudioEventEmitter3D::get_stop_event() const
{
	return implementation.stop_event;
}

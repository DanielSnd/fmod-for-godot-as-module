...
void StudioSystem::set_instance(FMOD::Studio::System* _studio_system)
{
	this->studio_system = _studio_system;
}
...
void EventDescription::set_instance(FMOD::Studio::EventDescription* _event_description)
{
...
String EventDescription::get_parameter_label_by_name(const String& name, int label_index)
{
	...
	do
	{
		...
		if (result == FMOD_ERR_INVALID_PARAM || result == FMOD_ERR_EVENT_NOTFOUND)
		{
			ERR_PRINT(vformat("Failed to get Parameter Label By Name %s %s %s", __FUNCTION__, __FILE__, __LINE__));
			break;
		}
	} while (result == FMOD_ERR_TRUNCATED);
		...
		int label_index) const
{
	...
	do
	{
		...
		if (result == FMOD_ERR_INVALID_PARAM || result == FMOD_ERR_EVENT_NOTFOUND)
		{
			ERR_PRINT(vformat("Failed to get Parameter Label By ID %s %s %s", __FUNCTION__, __FILE__, __LINE__));
			break;
		}
	} while (result == FMOD_ERR_TRUNCATED);
...
void EventInstance::set_instance(FMOD::Studio::EventInstance* _event_instance)
{
	this->event_instance = _event_instance;
}
...
void Bus::set_instance(FMOD::Studio::Bus* _bus)
{
	this->bus = _bus;
}
...
void VCA::set_instance(FMOD::Studio::VCA* _vca)
{
	this->vca = _vca;
}
...
void Bank::set_instance(FMOD::Studio::Bank* _bank)
{
	this->bank = _bank;
}
...
void CommandReplay::set_instance(FMOD::Studio::CommandReplay* _command_replay)
{
	this->command_replay = _command_replay;
}
